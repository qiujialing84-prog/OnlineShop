...
<%
    ...
    boolean isAdmin = request.getAttribute("isAdmin") != null;
%>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<%=contextPath%>/orders">${isAdmin ? '订单管理' : '我的订单'}</a></li>
    ...
    <script>
        ...
        function updateStatus(newStatus) {
            ...
            if (confirm(`确定将订单状态更新为"${statusText}"吗？`)) {
                fetch('<%=contextPath%>/admin/order', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
                    body: 'action=update&id=${order.id}&status=' + newStatus
                })
                .then(response => {
                    if (response.ok) {
                        location.reload();
